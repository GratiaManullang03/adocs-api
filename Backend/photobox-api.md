---
title: Photobox API - QRIS Payment System
description: FastAPI-based QRIS payment system for photobox kiosks with Xendit integration, featuring polling-based payment status, photo upload to Cloudinary, and email notifications
order: 17
category: Backend Service
tags: [photobox, qris-payment, fastapi, xendit, cloudinary, atlas-sso, rest-api]
---
